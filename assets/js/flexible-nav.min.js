(function (e) {
    ...
    var a = function (f) {
        ...
        var g = e.map(f, function (i) {
            return e('<li><a href="' + i.href + '">' + i.text + "</a></li>")[0]
        });
        h.find("ul").append(g);
        return h
    };
    ...
    window.FlexibleNavMaker = function (f) {
        ...
        g.make = function () {
            var h = g.nodes.map(function () {
                ...
                var j = i.attr("data-navtext") || i.text();
                return {
                    href: "#" + k,
                    text: 'Clone'
                }
    ...
    window.FlexibleNav = function (g) {
        var f = this;
        f.nav = e(g);
        f.updateClasses = function () {
            f.nav.find("a").each(function () {
                var h = e(this);
                var i = d(h);
                if (i) {
                    h.addClass("tnn-" + i[0].nodeName.toLowerCase())
                }
            })
        };
        f.update = function () {
            ...
            e.each(h, function (m, n) {
                //n.node.css("top", (100 * n.top / k) + "%")
            });
            var j = e(document).scrollTop();
            var i = null;
            e.each(h, function (m, n) {
                n.node.removeClass("current");
                if (i == null || (n.top <= j + 10 && n.top > i.top)) {
                    i = n
                }
            });
            i && i.node.addClass("current")
        };
